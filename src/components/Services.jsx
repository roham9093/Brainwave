                ...
                border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                    ...
                    md:w-3/5 xl:w-auto'>
                        ...
                        <div className='relative z-1 max-w-[17rem] ml-auto'>
                            ...
                            <p className='body-2 mb-[3rem] text-n-3 '>Brainwave unlocks the pontential of AI-powered Applications.</p>
                            <ul className='body-2'>
                                {
                    ...
                    <div className='relative z-1  grid gap-5 lg:grid-cols-2'>
                        ...
                        <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                            <div className='py-12 px-4 xl:p-8'>
                                ...
                                <p className='body-2 mb-[2rem] text-n-3'>The Worlds most powerfull AI Photo and video art Generation
                                    engin. what will you create? </p>
                                <ul className='flex items-center justify-between'>
                                    {brainwaveServicesIcons.map((item, index) => (
                                        <li
                                            ...
                                            key={index}
                                        >
                                            <div className={index === 2 ? 'flex items-center  justify-center w-full h-full bg-n-7 rounded0[1rem]' : ''}>
                                                <img
                                                    width={24}
                                                    height={24}
                                                    src={item}
