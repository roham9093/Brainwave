                ...
                md:mb-20 lg:mb-[6rem]'>
                    <h1 className='h1 mb-6'>
                        ...
                        <span className='inline-block relative'>
                            Brainwave
                            <img src={curve} alt="curve" className='absolute top-full left-0 w-full
                                xl:-mt-2'
                                width={624}
                                height={28}
                            />
                ...
                <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
                    <div className='relative z-1 p-0.5 rounded-2xl bg-conic-gradient'>
                        <div className='relative bg-n-8 rounded-[1rem]'>
                            ...
                            md:aspect-[688/490] lg:aspect-[1024/490]'>
                                <img className='w-full scale-[1.7] translate-y-[8%]
                                md:scale-[1] md:-translate-y-[10%] lg:-translate-y-[23%]' width={1024} height={490} src={robot} alt="AI" />
                                <Generating className="absolute left-4 right-4 bottom-5
                                    md:left-1/2 md:right-auto md:bottom-8 md:w-[30rem]
                                    md:-translate-x-1/2" />
                    ...
                    md:w-[138%] lg:-top-[104%]'>
                        <img
                            ...
                            className='w-full'
                            src={heroBackground} alt="hero background"
                        />
                    </div>
                    <BackgroundCircles />
                </div>
